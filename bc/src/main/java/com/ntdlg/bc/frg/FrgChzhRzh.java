...
//  FrgChzhRzh
//
//  Created by DELL on 2017-07-31 11:55:00
...
import static com.ntdlg.bc.F.document;
import static com.ntdlg.bc.F.readClassByJson;


public class FrgChzhRzh extends BaseFrg {
    ...
    protected void create(Bundle savedInstanceState) {
        setContentView(R.layout.frg_chzh_rzh);
        initView();
        loaddata();
    }
        ...
        mTextView_shenqing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mMGridPhotoChoose.getData().size() <= 0) {
                    ...
                    loadJsonUrl(document, new Gson().toJson(mBeanZDRZ));
                }
            }
        });
    }
