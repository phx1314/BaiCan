...
//  FrgGt
//
//  Created by DELL on 2019-08-02 09:22:10
...
public class FrgGt extends BaseFrg {
    ...
    protected void create(Bundle savedInstanceState) {
        setContentView(R.layout.frg_gt);
        initView();
        loaddata();
    }
    ...
    private void findVMethod() {
        ...
        mLinearLayout_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rZhengWb(getActivity(), MxParam.PARAM_TASK_FUND,FrgGt.this);
            }
        });
        mLinearLayout_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                rZhengWb(getActivity(), MxParam.PARAM_TASK_SECURITY,FrgGt.this);
            }
        });
    }
