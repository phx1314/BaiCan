...
import com.framewidget.util.UiUtils;

public class DynamicWave extends View {

    // 波纹颜色
    public int WAVE_PAINT_COLOR = 0xffffffff;

    public void setWAVE_PAINT_COLOR(int wAVE_PAINT_COLOR) {
        WAVE_PAINT_COLOR = wAVE_PAINT_COLOR;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 减height只是为了控制波纹绘制的y的在屏幕的位置，大家可以改成一个变量，然后动态改变这个变量，从而形成波纹上升下降效果
            // 绘制第一条水波纹
